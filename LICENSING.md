...
A `LICENSE-intentkit` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [crestalnetwork/intentkit](https://github.com/crestalnetwork/intentkit), Copyright
2024 Crestal Network, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../intentkit-port/specs/SPEC-001-intentkit.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
